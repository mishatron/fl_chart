...
class ScatterChartData extends AxisChartData with EquatableMixin {
  ...
  ///
  /// if [backgroundColors] are specified - area will wi divided into multiple parts, each of specified color
  ScatterChartData({
  ...
  ScatterChartData lerp(BaseChartData a, BaseChartData b, double t) {
    if (a is ScatterChartData && b is ScatterChartData && t != null) {
      return ScatterChartData(
        ...
        backgroundColors: lerpColorList(a.backgroundColors, b.backgroundColors, t)
      );
    } else {
